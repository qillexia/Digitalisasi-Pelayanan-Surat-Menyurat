...
<aside id="sidebar-wrapper" class="bg-white border-end d-flex flex-column p-3 shadow-sm">
    ...
    <nav class="nav flex-column flex-grow-1 gap-2">
        ...
        <a href="ManajemenPengguna.php" class="sidebar-link d-flex align-item   s-center gap-3 px-3 py-2 rounded-3 <?php echo ($currentPage == 'ManajemenPengguna.php') ? 'active' : ''; ?>">
