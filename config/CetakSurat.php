...
<body>
    ...
    <div class="sheet">
        <div class="header">
            ...
            <p>Jalan Syech Muhibat Windusengkahan
                Kode Pos : 45515</p>
        </div>
        ...
        <div class="isi">
            ...
            <table class="tabel-bio">
                ...
                <tr>
                    <td>Jenis Kelamin</td>
                    <!-- Mengubah format: hapus underscore dan kapital setiap kata -->
                    <td>: <?= ucwords(str_replace('_', ' ', $data['jenis_kelamin'])) ?></td>
                </tr>
                <tr>
                    <td>Pekerjaan</td>
                    <td>: <?= ucwords(str_replace('_', ' ', $data['pekerjaan'])) ?></td>
                </tr>
                <tr>
                    <td>Agama</td>
                    <td>: <?= ucwords(str_replace('_', ' ', $data['agama'])) ?></td>
                </tr>
                <tr>
                    <td>Status Perkawinan</td>
                    <td>: <?= ucwords(str_replace('_', ' ', $data['status_perkawinan'])) ?></td>
                </tr>
                <tr>
                    <td>Alamat</td>
                    <td>: <?= $data['alamat'] ?></td>
        ...
        <div class="ttd">
            ...
            <p style="text-decoration: underline; font-weight: bold;">Didi Supardi</p>
        </div>
    </div>
