...
<body class="bg-light">
                ...
                <div class="row align-items-center gy-5">
                    <div class="col-lg-6 text-center text-lg-start">
                        ...
                        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-lg-start">
                            <a href="#" class="btn btn-success btn-lg px-3 gap-2 fs-6">Ajukan Surat</a>
                            <a href="#" class="btn btn-outline-success btn-lg px-3 fs-6">Pelajari Alur</a>
                        </div>
                    </div>
                    <div class="col-lg-5 offset-lg-1">
                        <div class="bg-secondary-subtle rounded-5 d-flex align-items-center justify-content-center text-secondary" style="height: 350px;">
                            <span class="h4">Area Gambar / Ilustrasi</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-4 text-center">
                    ...
                    <div class="col-md-6 col-lg-3 step-arrow">
                        <div class="card h-100 border-0 shadow-sm bg-light p-4 rounded-4 position-relative z-1">
                            <div class="d-flex align-items-center justify-content-center bg-success-subtle text-success rounded-circle mb-4 mx-auto" style="width: 60px; height: 60px;">
    ...
    <footer id="contact" class="text-white pt-5 pb-4 mt-5 border-top border-4 border-warning" style="background-color: #0f5233;">
        <div class="container">
            ...
            <div class="text-center">
                <p class="small text-white-50 mb-0">
                    &copy; 2025 <strong>Balai Desa Windusengkahan</strong>. <a href="https://www.instagram.com/haqilabd/" class="text-white-50 text-decoration-none">Created By @haqilabd.</a>
                </p>
            </div>
        </div>
    </footer>
